...
class InterfazApp(Tk):
    ...
    def contrubuir_widget(self):
        ...
        #caja para capturar  carrera
        self.label_=Label(self.cajas_texto,text="carrera",
        bg=COLOR_FONDO_PRIMARIO,fg="white",font=("Roboto",10)).pack(pady=10)
        self.carrera_texto=Entry(self.cajas_texto,bd=0,width=12,font=("Arial",14))
        self.carrera_texto.pack()
        ...
        self.tabla_datos.heading("#2",text="Carrera")
        alumnitos=[
            ("lupita","cervantes","administracion"),
            ("mariciela","arcel","computacion"),
            ("luis","cantalin","arquitectura"),
            ("juan","guadalupe","fisica")
        ]
        for nom,ape,carrera in alumnitos:
            self.tabla_datos.insert("",END,text=nom,values=(ape,carrera))
